...
public class BlogSearchActivity extends AppCompatActivity {
    ...
    final static String TAG = "BlogSearchActivity";
...
//    ImageFileManager imgManager;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lvBlogList = findViewById(R.id.lvBlogList);

        resultList = new ArrayList();
        adapter = new BlogLinkAdapter(this, R.layout.listview_blog, resultList);
        ...
        lvBlogList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                NaverBlogDto dto = resultList.get(position);
                String link = dto.getBlogLink();
    ...
    class NaverAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDlg = ProgressDialog.show(BlogSearchActivity.this, "Wait", "Downloading...");
        }
